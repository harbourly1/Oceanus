...
export default function AllocationLogsPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      header: 'Lead',
      render: (r: any) => (
        <Link href={`/sales/leads/${r.lead?.id}`} className="text-blue-500 hover:underline">
          {r.lead?.ref || r.leadId}
        </Link>
      ),
    },
    ...
    },
    {
      ...
      render: (r: any) => (
        <span
          ...
          style={{
            background: r.method === AllocationMethod.ROUND_ROBIN ? 'rgba(59, 130, 246, 0.15)' : 'rgba(107, 114, 128, 0.15)',
            color: r.method === AllocationMethod.ROUND_ROBIN ? '#3b82f6' : '#6b7280',
          }}
        >
    ...
    },
    {
      key: 'pool',
      header: 'Pool',
      render: (r: any) => r.pool?.name || '-',
    },
    {
      key: 'assignedBy',
      header: 'Assigned By',
      render: (r: any) => r.assignedBy?.name || 'System',
    },
    {
      key: 'reason',
      header: 'Reason',
        ...
        <div className="flex gap-3 items-center">
          <Select
            ...
            options={[
              ...
              { value: AllocationMethod.ROUND_ROBIN, label: 'Round Robin' },
              { value: AllocationMethod.MANUAL, label: 'Manual' },
            ]}
            className="w-40"
          />
